...
export const metadata: Metadata = {
  title: "KALEO - Official Website | Icelandic Rock Band",
  description: "Official website of Kaleo, the Icelandic blues rock band. Stream music, tour dates, merchandise, and connect with the band.",
  keywords: "Kaleo, Icelandic rock band, blues rock, Surface Sounds, Jökull Júlíusson, concert tickets",
  metadataBase: new URL("https://kaleo.com"),
  alternates: {
    canonical: "https://kaleo.com"
  },
  openGraph: {
    title: "KALEO - Official Website",
    description: "Icelandic rock band bringing soulful blues and alternative rock to stages worldwide",
    url: "https://kaleo.com",
    siteName: "KALEO",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763716298370-d46eajox.jpg",
        alt: "Kaleo performing live on stage"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "KALEO - Official Website",
    description: "Icelandic rock band bringing soulful blues and alternative rock to stages worldwide",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763716298370-d46eajox.jpg"]
  },
  robots: {
    index: true,
    follow: true
